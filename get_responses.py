...
from utils.llm_responses_utils import gpt_responses, claude_responses
...
def main(args):
    ...
    file_name = f"./results/responses/responses_of_{args.test_model}_{args.save_suffix}.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_model', type=str, default="gpt-3.5-turbo", 
                        choices=["gpt-3.5-turbo", "gpt-4", "anthropic.claude-v1", "anthropic.claude-v2"], 
